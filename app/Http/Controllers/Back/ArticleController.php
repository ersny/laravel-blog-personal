...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $request->image->move(public_path('uploads'),$imageName); //Dosyaya Kaydediyoruz
            $article->image='uploads/'.$imageName;
        }
        $article->save(); // Yukarda verdiğimiz bilgileri veritabanına kaydediyoruz
    ...
    {
        $article =Article::findOrFail($id); // findOrFail eğer öyle bir data yoksa 404 yönlendirmesini yapıyor.
        $categories=Category::all();
