    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if(Request::segment(2)=="panel") active @endif ">
                ...
                <li class="nav-item">
                    <a class="nav-link  @if(Request::segment(2)=="panel") in @else collapsed @endif" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <li class="nav-item">
                    <a class="nav-link  @if(Request::segment(2)=="panel") in @else collapsed @endif" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true" aria-controls="collapsePage">
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <a class="dropdown-item text-center small text-gray-500" href="{{asset('back/')}}/#">Read More Messages</a>
                    </div>
                </li>
